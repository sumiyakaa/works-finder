...
export const works: Work[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    purpose: '集客・体験予約',
    summary:
      'キッズ・マザー・ファザーの3コースをカードで紹介し、コース詳細モーダルとFlatpickr予約フォームで体験申し込みまで1ページ内で完結させた親子向け英会話教室LP。',
    pageCount: 1,
    scale: null,
    features: ['アニメーション', 'フォーム', '予約導線', 'モーダルUI'],
    techTags: ['JavaScript', 'Formspree', 'Flatpickr'],
    techStack: ['HTML', 'CSS', 'JavaScript', 'Formspree', 'Flatpickr'],
    budgetRange: '¥150,000〜230,000',
    durationRange: null,
    tags: ['英会話教室', '体験予約', 'モーダルUI', 'コース紹介', 'スクロールアニメーション'],
    year: 2026,
    isFeatured: false,
    hasCms: false,
    hasAnimation: true,
    hasForm: true,
    challenge:
      'コース詳細と予約フォームをモーダルに集約し、1ページ内で完結する体験予約導線を設計した。',
